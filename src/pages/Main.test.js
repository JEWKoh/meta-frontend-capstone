...
jest.mock("../Hero", () => () => <div data-testid="hero-section"></div>);
jest.mock("../Specials", () => () => <div data-testid="specials-section"></div>);
jest.mock("../Testimonials", () => () => <div data-testid="testimonials-section"></div>);
jest.mock("../About", () => () => <div data-testid="about-section"></div>);
